...
public class Blinky extends Enemy{
    ...
    public Blinky(PlayScreen screen, float x, float y){
        super(screen, x, y);
        in = once =false;
        stateTimer = 0;
        velX = 0f;
        ...
        for (int i = 0 ; i  < 8; ++i)
            frames.add(new TextureRegion((screen.getAtlas().findRegion("Blinky")), i*16, 0, 16, 16));
    ...
    protected void defineEnemy() {
        ...
        fdef.filter.maskBits = Main.DIRECTION_BIT | Main.BORDER_BIT | Main.PACMAN_BIT ;
        ...
        body.createFixture(fdef).setUserData("Blinky");
    }
    @Override
